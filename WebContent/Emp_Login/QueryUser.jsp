...
<%
	List<Login> list = (List<Login>)session.getAttribute("LoginById");
	if(list==null){
		response.sendRedirect("/attendance/UserLoginServlet");
		return;
	}
%>
<body>
			...
			<div class="col-md-12 span_3">
			  <div class="bs-example1" data-example-id="contextual-table">
			    <table class="table table-hover">
			      ...
			      <tbody>
			        <tr>
			          <td><%=list.get(0).getLoginId() %></td>
			          <td><%=list.get(0).getLoginPwd() %></td>
...
<%
session.removeAttribute("LoginById");
%>
</body>
</html>
