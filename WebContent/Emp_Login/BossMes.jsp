...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
	   <div class="md">
		 <h3 style="display: inline-block;">特殊信息提交</h3>
		 	
		<form action="/attendance/InsertMessageServlet">
			<div class="dropdown" style="display: inline-block; float: right; margin:0 20px 0 0 ;">
			...
			<textarea class="formabc" rows="25" name="getMessage"><%
																  ...
																  %></textarea>
			<input type="submit" value="提交" style="float: right; margin:20px 20px 0 0 ; width: 200px;"/>
		</form>
