...
<%
	...
	if(list==null){
		response.sendRedirect("/attendance/ListUserServlet?flag=1");
		return;
	}
%>
<body>
			    ...
			    <table class="table table-hover">
			      ...
			      <tbody>
			        <tr>
			          ...
			          <td><%=list.get(0).getUserPost() %></td>
			          <td><%=list.get(0).getUserSal() %></td>
			          <td><%=list.get(0).getClockNum() %></td>
			          <td><%=list.get(0).getEntry_time() %></td>
			          <td><a href="Mes.jsp">点击跳转</a></td>
			        </tr>
			      </tbody>
			    </table>
			   </div>
