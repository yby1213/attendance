...
<%
	...
	if(listUser==null){
		response.sendRedirect("/attendance/QueryUserServlet?flag=1");
		return;
	}
%> 
<body>
			    ...
			    <table class="table table-hover">
			      ...
			      <tbody>
			        ...
			        <tr>
			          ...
			          <td><a href="/attendance/ByIdQueryLoginServlet2?userId=<%=listUser.get(i).getUserId() %>&flag=1">修改用户信息</a></td>
			          <td><a href="/attendance/ByIdQueryLoginServlet2?userId=<%=listUser.get(i).getUserId() %>&flag=2">删除用户信息</a></td>
			        </tr>
			        <%
			        }
			        %>
