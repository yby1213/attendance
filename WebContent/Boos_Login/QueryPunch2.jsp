     ...
     <!-- Navigation -->
	   ...
	   <div class="md">
		...
		<div class="col-md-12 span_3">
			    ...
			    <table class="table table-hover">
			      <thead>
			       ...
			       <%-- <%
			      		...
			      		if(clockList == null){
			      			response.sendRedirect("/attendance/GetAllClockMessServlet?method=query");
			      			return;
			      		}
			       %> --%>
			      <tbody id="insert">
		    ...
		    <%-- <c:if test="${empty pageListNews }"> --%>
     			<input id="pageIndex" type="hidden" value="1" />
      		<%-- </c:if> --%>
      		
			当前页数:[${pageListNews.page }/${pageListNews.totalPage } ]&nbsp; 
       		<%-- <c:if test="${pageListNews.page > 1 }"> --%>
       		
		       	<p class="c"><a href="" class="change">首页</a></p>
		       	
		       		<p class="c"><a href="" class="change">上一页</a></p> 
       		<%-- </c:if> --%>
       		<%-- <c:if test="${pageListNews.page < pageListNews.totalPage }"> --%>
       		
		       	<p class="c"><a href="" class="change">下一页</a></p>
		       	
		        <a href="" class="change">末页</a> 
       		<%-- </c:if> --%>
...
%>
<%
	session.removeAttribute("pageListNews");
%>
</html>
