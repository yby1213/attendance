...
if(flag==1){
	...
	if(listUser==null){
		response.sendRedirect("/attendance/QueryUserServlet?flag=3");
		return;
	}
	}
//flag为其他值的时候进入根据ID查询界面
	if (listUser == null) {
		response.sendRedirect("/attendance/ByIdQueryLoginServlet?flag=2");
		return;
	}
%>
			...
			<div class="col-md-12 span_3">
			  <div class="bs-example1" data-example-id="contextual-table">
			    <table class="table table-hover">
			      ...
			      %>
			        <tr>
			          <td><%=listUser.get(0).getLoginId() %></td>
			          <td><%=listUser.get(0).getLoginPwd() %></td>
			          <td id="UserId"><%=listUser.get(0).getUserId() %></td>
			          <td><a href="/attendance/DelLoginServlet?userId=<%=listUser.get(0).getUserId() %>" >确认删除</a></td>
			        </tr>
			        <%} %>
			        <%if(flag==9){
			        ...
			        %>
			         <tr>
			          <td><%=listUser.get(i).getLoginId() %></td>
			          <td><%=listUser.get(i).getLoginPwd() %></td>
			          <td id="UserId"><%=listUser.get(i).getUserId() %></td>
			          <td><a href="/attendance/DelLoginServlet?userId=<%=listUser.get(i).getUserId() %>" >确认删除</a></td>
			        </tr>
			        <%} 
			        }
			        %>
